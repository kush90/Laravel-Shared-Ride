            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <hr>
                    <form class="form-horizontal" method="post" name="signup" id="signup" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="name" class="form-control" name="name" style="height: 30px;" placeholder="Enter Your Full Name"/>
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-3">Driver Lience Photo<span class="text-danger">*</span>
                            </label>
                            <div class="col-md-5 col-sm-8">
                                <div class="input-group" id="f"> <span class="input-group-addon" id="file_upload"><i class="fa fa-picture-o" aria-hidden="true"></i></span>

                                    <input type="file" style="padding:3px;" name="lience"  id="file_nm" class="form-control upload " placeholder="" aria-describedby="file_upload">
                                </div>
                                @if ($errors->has('lience'))
                                    <span class="help-block">
                                        <p style="color:red;font-size: 12px;">*{{ $errors->first('lience') }}</p>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-3">Car Number<span class="text-danger">*</span></label>
                            <div class="col-md-5 col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-car" aria-hidden="true"></i></span>
                                    <input type="text" class="form-control" name="carnumber" id="contactnum" placeholder="Enter your car number" value="">
                                </div>
                                @if ($errors->has('carnumber'))
                                    <span class="help-block">
                                        <p style="color:red;font-size: 12px;">*{{ $errors->first('carnumber') }}</p>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-3">Type of Car<span class="text-danger">*</span></label>
                            <div class="col-md-5 col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-car" aria-hidden="true"></i></span>
                                    <input type="text" class="form-control" name="typeofcar" id="contactnum" placeholder="Enter your type of car" value="">
                                </div>
                                @if ($errors->has('typeofcar'))
                                    <span class="help-block">
                                        <p style="color:red;font-size: 12px;">*{{ $errors->first('typeofcar') }}</p>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-3">Color of Car<span class="text-danger">*</span></label>
                            <div class="col-md-5 col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-car" aria-hidden="true"></i></span>
                                    <input type="color" id="color" name="color" style="height: 30px;"/>
